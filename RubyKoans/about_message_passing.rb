...
class AboutMessagePassing < Neo::Koan
  ...
  class AllMessageCatcher
    # RAILS IMA SLICNO ZA NEKE MAGIC METHODE: npr find_by_nekoimepolja(...)
    # To je dinamicki generisano ime methode.
    # &block = specijalni argument koji se ondosi na prosledjeni block
