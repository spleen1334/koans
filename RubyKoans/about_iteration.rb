...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Kombinuje vrednosti parametara.
    # Ukoliko mu se prosledi argument (inject(0)) to je pocetna vrednost,
    # bez argumenta inital value je prvi element []
    #
    # Kad se prosledjuje block, argumenti sadrze SUMU (acumulated value) i sam
    # ELEMENAT ( |sum, item| .... |product, item|... )
    #
    # Skracen oblik moze sa prosledjivanjem symbola:
    # [2,3,4].inject(:+)
    # [2,3,4].inject(:*)
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    File.open("example_file.txt") do |file|
      upcase_lines = file.map { |line| line.strip.upcase } # strip uklanja leading & trailing whitespace od stringa
