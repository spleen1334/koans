...
class AboutBlocks < Neo::Koan
  def method_with_block
    # YIELD
    # mozemu se prosledjivati ili uzimati iz yield
    result = yield # slicno kao i  za rails/lara view template (ovde se ubacuje kod koji je prosledjen kao block)
    result
  end
  ...
  def test_blocks_can_take_arguments
    method_with_block_arguments do |argument| # ovo je sad obrnuto uzimamo Jim iz yield, tacnije pozivamo yield iz arg
